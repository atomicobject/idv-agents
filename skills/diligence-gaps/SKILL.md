...
*Generated by idv-agents v1.0, based on the IDV Due Diligence Checklist. Not a substitute for actual IDV diligence.*
```
...
- **Always include the caveat footer verbatim**: *"Generated by idv-agents v1.0, based on the IDV Due Diligence Checklist. Not a substitute for actual IDV diligence."*
