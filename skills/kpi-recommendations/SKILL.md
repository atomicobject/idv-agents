...
*Generated by idv-agents v1.1, based on the IDV Fundraising + AI Playbook (Portfolio Summit 2026). KPI recommendations are a starting point — calibrate with your lead investor.*
```
...
- **Always include the caveat footer verbatim**: *"Generated by idv-agents v1.1, based on the IDV Fundraising + AI Playbook (Portfolio Summit 2026). KPI recommendations are a starting point — calibrate with your lead investor."*
