...
> *Generated by idv-agents v1.0, based on the IDV Fundraising + AI Playbook (Portfolio Summit 2026). Research components are AI-assisted; talking points and objection responses require your judgment per IDV's playbook §6.4.*
...
- **Always include the caveat footer verbatim**: *"Generated by idv-agents v1.0, based on the IDV Fundraising + AI Playbook (Portfolio Summit 2026). Research components are AI-assisted; talking points and objection responses require your judgment per IDV's playbook §6.4."*
