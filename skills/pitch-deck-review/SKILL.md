...
*Generated by idv-agents v1.0, based on the IDV Fundraising + AI Playbook (Portfolio Summit 2026). Automated first-pass review — not a substitute for an IDV partner review.*
```
...
- **Always include the caveat footer verbatim**: *"Generated by idv-agents v1.0, based on the IDV Fundraising + AI Playbook (Portfolio Summit 2026). Automated first-pass review — not a substitute for an IDV partner review."*
